...
{
    "name": "The Orb of Dilaaria",
    "image": "https://ifilex.github.io/WineBOX-Store/box/orb.jpg",
    "description": "The Orb of Dilaaria es un mod total conversion de Wolfenstein 3D ambientado en un mundo de fantasía oscura, lanzado en 2006 por el desarrollador Adam Biser. La historia transcurre en la Tierra de los Siete Reinos, otrora pacífica creación de Eilior, el Gran Ser, que fue sumida en el caos cuando el señor oscuro Wersin disolvió el Nonacyclus y se alzó con el Orbe, la reliquia que protegía a la humanidad. Como un solitario guardia del palacio, comienzas prisionero en una celda con solo una maza como arma, pero irás adquiriendo armamento mágico mientras te enfrentas a las fuerzas del mal. El juego destaca por su progresión no lineal, con caminos ramificados y mutuamente excluyentes a lo largo de seis episodios de cinco niveles cada uno, además de un \"Bestiario\" que muestra información sobre los nuevos enemigos entre niveles. También incluye áreas al aire libre y submarinas, y una dificultad notablemente alta que recomienda empezar en el nivel más fácil.",
    "description": {
        "es": "The Orb of Dilaaria es un mod total conversion de Wolfenstein 3D ambientado en un mundo de fantasía oscura, lanzado en 2006 por el desarrollador Adam Biser. La historia transcurre en la Tierra de los Siete Reinos, otrora pacífica creación de Eilior, el Gran Ser, que fue sumida en el caos cuando el señor oscuro Wersin disolvió el Nonacyclus y se alzó con el Orbe, la reliquia que protegía a la humanidad. Como un solitario guardia del palacio, comienzas prisionero en una celda con solo una maza como arma, pero irás adquiriendo armamento mágico mientras te enfrentas a las fuerzas del mal. El juego destaca por su progresión no lineal, con caminos ramificados y mutuamente excluyentes a lo largo de seis episodios de cinco niveles cada uno, además de un \"Bestiario\" que muestra información sobre los nuevos enemigos entre niveles. También incluye áreas al aire libre y submarinas, y una dificultad notablemente alta que recomienda empezar en el nivel más fácil.",
        "de": "The Orb of Dilaaria ist eine Total Conversion von Wolfenstein 3D, die in einer düsteren Fantasy-Welt spielt und 2006 vom Entwickler Adam Biser veröffentlicht wurde. Die Geschichte spielt im Land der Sieben Königreiche, einst eine friedliche Schöpfung von Eilior, dem Großen Wesen, das ins Chaos gestürzt wurde, als der dunkle Lord Wersin den Nonacyclus auflöste und den Orb an sich riss, das Relikt, das die Menschheit schützte. Als einsamer Palastwächter beginnst du in einer Gefängniszelle mit nur einem Streitkolben als Waffe, erwirbst aber nach und nach magische Waffen, während du dich den Mächten des Bösen stellst. Das Spiel besticht durch seinen nichtlinearen Fortschritt mit verzweigten, sich gegenseitig ausschließenden Pfaden über sechs Episoden mit je fünf Levels sowie einem \"Bestiarium\", das zwischen den Levels Informationen über neue Gegner zeigt. Es enthält auch Außen- und Unterwasserbereiche und einen bemerkenswert hohen Schwierigkeitsgrad, der empfiehlt, mit der einfachsten Stufe zu beginnen.",
        "fr": "The Orb of Dilaaria est une total conversion de Wolfenstein 3D située dans un monde de dark fantasy, sortie en 2006 par le développeur Adam Biser. L'histoire se déroule dans la Terre des Sept Royaumes, autrefois création paisible d'Eilior, le Grand Être, qui fut plongée dans le chaos lorsque le seigneur des ténèbres Wersin dissout le Nonacyclus et s'empara de l'Orbe, la relique qui protégeait l'humanité. En tant que garde solitaire du palais, tu commences prisonnier dans une cellule avec seulement une masse comme arme, mais tu acquerras progressivement des armes magiques en affrontant les forces du mal. Le jeu se distingue par sa progression non linéaire, avec des chemins ramifiés et mutuellement exclusifs à travers six épisodes de cinq niveaux chacun, ainsi qu'un « Bestiaire » qui affiche des informations sur les nouveaux ennemis entre les niveaux. Il comprend également des zones en plein air et sous-marines, et une difficulté remarquablement élevée qui recommande de commencer au niveau le plus facile.",
        "it": "The Orb of Dilaaria è una total conversion di Wolfenstein 3D ambientata in un mondo dark fantasy, pubblicata nel 2006 dallo sviluppatore Adam Biser. La storia si svolge nella Terra dei Sette Regni, un tempo pacifica creazione di Eilior, il Grande Essere, precipitata nel caos quando il signore oscuro Wersin dissolse il Nonacyclus e si impossessò dell'Orbe, la reliquia che proteggeva l'umanità. Nei panni di un solitario guardiano del palazzo, inizi prigioniero in una cella con solo una mazza come arma, ma acquisirai gradualmente armamenti magici affrontando le forze del male. Il gioco si distingue per la sua progressione non lineare, con percorsi ramificati e mutuamente esclusivi attraverso sei episodi di cinque livelli ciascuno, oltre a un \"Bestiario\" che mostra informazioni sui nuovi nemici tra i livelli. Include anche aree all'aperto e subacquee, e una difficoltà notevolmente alta che consiglia di iniziare dal livello più facile.",
        "pt": "The Orb of Dilaaria é uma total conversion de Wolfenstein 3D ambientada em um mundo de fantasia sombria, lançada em 2006 pelo desenvolvedor Adam Biser. A história se passa na Terra dos Sete Reinos, outrora pacífica criação de Eilior, o Grande Ser, que foi mergulhada no caos quando o senhor das trevas Wersin dissolveu o Nonacyclus e tomou o Orbe, a relíquia que protegia a humanidade. Como um solitário guarda do palácio, você começa prisioneiro em uma cela com apenas uma maça como arma, mas irá adquirindo armamento mágico enquanto enfrenta as forças do mal. O jogo se destaca por sua progressão não linear, com caminhos ramificados e mutuamente exclusivos ao longo de seis episódios de cinco níveis cada, além de um \"Bestiário\" que mostra informações sobre os novos inimigos entre os níveis. Também inclui áreas ao ar livre e subaquáticas, e uma dificuldade notavelmente alta que recomenda começar no nível mais fácil.",
        "ru": "The Orb of Dilaaria — это тотальная конверсия Wolfenstein 3D, действие которой происходит в мрачном фэнтезийном мире; мод выпущен в 2006 году разработчиком Адамом Байзером. Сюжет разворачивается в Земле Семи Королевств, некогда мирном творении Эйлиора, Великого Существа, которое погрузилось в хаос, когда тёмный лорд Версин разрушил Нонацикл и завладел Орбом — реликвией, защищавшей человечество. В роли одинокого дворцового стража вы начинаете в тюремной камере с одной лишь булавой в качестве оружия, но постепенно обретаете магическое вооружение, сражаясь с силами зла. Игра выделяется нелинейным прохождением с разветвлёнными, взаимоисключающими путями на протяжении шести эпизодов по пять уровней в каждом, а также «Бестиарием», отображающим информацию о новых врагах между уровнями. Также включает открытые и подводные зоны и заметно высокую сложность, которая рекомендует начинать с самого лёгкого уровня.",
        "zh": "The Orb of Dilaaria 是 Wolfenstein 3D 的一款全面转换模组，背景设定在一个黑暗奇幻世界，由开发者 Adam Biser 于 2006 年发布。故事发生在七王国之地，这里曾是伟大存在 Eilior 的和平造物，但当黑暗领主 Wersin 解散 Nonacyclus 并夺取了保护人类的遗物——宝球（Orb）后，世界陷入了混乱。作为一名孤独的宫殿守卫，你从牢房开始，仅有一把钉头锤作为武器，但会在对抗邪恶势力的过程中逐渐获得魔法武器。游戏以其非线性进程而著称，六个章节各含五个关卡，拥有分支且互斥的路径，此外还有在关卡间显示新敌人信息的“怪物图鉴”。游戏还包含露天和水下区域，以及相当高的难度，建议初次尝试时选择最简单难度。",
        "ja": "The Orb of Dilaariaは、開発者Adam Biserによって2006年にリリースされた、ダークファンタジーの世界を舞台にしたWolfenstein 3Dのトータルコンバージョンです。物語は、かつては偉大なる存在エイリオールの平和な創造物であった七王国の地で展開しますが、暗黒卿ウェルシンがノナシクルスを解散し、人類を守る遺物であるオーブを奪ったことで混沌に陥ります。孤独な宮殿の衛兵として、あなたは牢獄でメイス一本だけを武器に始めますが、邪悪な勢力と戦いながら徐々に魔法の武器を手に入れていきます。このゲームは、6つのエピソード（各5レベル）にわたる分岐し相互排他的な経路を持つ非線形の進行と、レベル間で新たな敵の情報を表示する「ベスティアリ」が特徴です。また、屋外や水中のエリアも含まれ、初回は最も簡単な難易度を選ぶことを推奨する、かなり高い難易度も備えています。"
    },
    "category": "games",
    "link": "https://ifilex.github.io/WineBOX-Store/dilaaria.html"
}
{
        "name": "Volcano",
