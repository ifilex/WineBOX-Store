...
function dialogPassphrase(){
    BootstrapDialog.show({
        ...
        closeByBackdrop: false,
        title: '<i class="fa fa-lg fa-fw fa-eye"></i> Your Secret Phrase',
        message: function(dialog){
            var msg = $('<div></div>');
            msg.append('<p>Write down or copy these words in right order and save them.</p>');
            msg.append('<div class="btc-wallet-passphrase">' + getWalletPassphrase() + '</div>');
            msg.append('<div class="alert alert-danger fade in center bold">' +
                            '<h3>Write your secret phrase down and keep it safe.</h3>' +
                            '<ul>' +
                                '<li><i>Do not share your secret phrase!</i></p>' +
                                '<li>If someone has your secret phrase, they will have full</p>' +
                                '<li>control of your wallet.</p>' +
                            '</ul>' +
                        '</div>');
            return msg;
        },
...
function dialogManualPassphrase(){
    BootstrapDialog.show({
        ...
        closeByBackdrop: false,
        title: '<i class="fa fa-lg fa-fw fa-keyboard-o"></i> Enter your private key',
...
function dialogNewPassphrase(){
    ...
    BootstrapDialog.show({
        ...
        title: '<i class="fa fa-lg fa-fw fa-eye"></i> Your recovery phrase',
        closable: false,
        closeByBackdrop: false,
...
function dialogLogout(){
    BootstrapDialog.show({
        ...
        message: function(dialog){
            var msg = $('<div class="center"></div>');
            msg.append('<p>Are you sure you want to logout?</p>');
...
function dialogWelcome(){
    BootstrapDialog.show({
        ...
        closable: false,
        closeByBackdrop: false,
        title: '<i class="fa fa-lg fa-fw fa-info-circle"></i> Welcome',
        message: $('<div></div>').load('html/welcome.html'),
        buttons:[{
            label: 'Import or recover wallet',
